...
class Solution {
public:
    string alienOrder(vector<string> &dictionary) {
        unordered_map<char, unordered_set<char>> adj;
        unordered_set<char> alphabet(dictionary[0].begin(), dictionary[0].end());
        ...
        // queue is changed to pq for lexicographically smallest topological sort
